...
import { APP_SHORT_TITLE, APP_TITLE } from "@/lib/appConfig";
import {
  GraduationCap,
  Camera,
  BarChart3,
        ...
        <div className="container relative">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-accent/10 text-accent text-sm font-medium mb-8">
              ...
              Intelligent Anti-Proxy Monitoring
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-3xl lg:text-4xl font-display font-bold mb-6">
                Why Choose Our
                <br />
                <span className="text-accent">{APP_SHORT_TITLE}?</span>
              </h2>
        ...
        <div className="container">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex max-w-3xl items-start gap-3">
              <div className="mt-0.5 h-8 w-8 flex-shrink-0 rounded-lg bg-primary flex items-center justify-center">
                <GraduationCap className="h-4 w-4 text-primary-foreground" />
              </div>
              <span className="font-display font-semibold leading-snug text-center sm:text-left">
                {APP_TITLE}
              </span>
            </div>
